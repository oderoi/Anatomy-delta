// Compute base URL relative to this module (js/data.js -> parent dir)
const BASE = new URL('../', import.meta.url).href;

function model(path) { return new URL('models/' + path, BASE).href; }
...
export const organById = Object.fromEntries(organs.map((o) => [o.id, o]));
